...
public class View {
        ...
        public void init(ViewModel vm) {
           ...
           clocks.clocksMap.forEach((f,p) -> {
            ...
            flist.myLineChartController.B_S_feature.bind(vm.B_S_feature);
    ...
    public void initFeature() {
            ...
            flist.myLineChartController.fList.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<String>() {
                ...
                public void changed(ObservableValue<? extends String> observableValue, String s, String t1) {
                    ...
                    myAlgoGraph.myAlgoGraphController.clear();
                    myAlgoGraph.myAlgoGraphController.set_algo_setting(vm.getpaintFunc());
                    vm.setbest_c_feature();
                    flist.myLineChartController.set_setting(pannel.controller.time_step.getValue(),vm.selected_feature_vector, vm.Best_c_feature_vector);
